...
const BlockRange g_SAM7X_BS_BlockRange[] =
{
    ...
    { MEMORY_BLOCKTYPE_GCC_SPECIAL_BOOTSTRAP,  5, 13 },
    { BlockRange::BLOCKTYPE_CODE            , 14, 41 },
    { MEMORY_BLOCKTYPE_GCC_SPECIAL_CODE     , 42, 43 },
    { BlockRange::BLOCKTYPE_DEPLOYMENT      , 44, 60 },
