...
namespace DFRobot_Motorshield
{
    public class Program
    {
        public static void Main()
        {
            ...
            SN754410 MotorDriver = new SN754410(Pins.GPIO_PIN_D6, Pins.GPIO_PIN_D7, Pins.GPIO_PIN_D5, Pins.GPIO_PIN_D4);
            // Older versions of the L293 use pin 8 instead of 4. If that's the case, use the line below
            // SN754410 MotorDriver = new SN754410(Pins.GPIO_PIN_D6, Pins.GPIO_PIN_D7, Pins.GPIO_PIN_D5, Pins.GPIO_PIN_D8);
