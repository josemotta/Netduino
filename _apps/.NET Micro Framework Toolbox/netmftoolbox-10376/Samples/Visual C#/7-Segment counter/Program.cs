...
namespace _7_Segment_counter
{
    public class Program
    {
        public static void Main()
        {
            ...
            Bitshift7Segment Display = new Bitshift7Segment(SPI_Devices.SPI1, Pins.GPIO_PIN_D10);

            // If we like, we can also chain up several bitshift IC's to support multiple (7-segment) devices:
            //Ic74HC595Chain Chain = new Ic74HC595Chain(SPI_Devices.SPI1, Pins.GPIO_PIN_D10, 2);
            //Bitshift7Segment Display1 = new Bitshift7Segment(Chain, 0);
            //Bitshift7Segment Display2 = new Bitshift7Segment(Chain, 1);
