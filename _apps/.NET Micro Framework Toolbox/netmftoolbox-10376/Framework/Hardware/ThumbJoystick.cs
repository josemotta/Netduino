...
using SecretLabs.NETMF.Hardware; // Only used for AnalogInput
...
namespace Toolbox.NETMF.Hardware
{
    ...
    public class ThumbJoystick : IDisposable
    {
        ...
        private SecretLabs.NETMF.Hardware.AnalogInput _Horizontal;
        /// <summary>Reference to the vertical pin</summary>
        private SecretLabs.NETMF.Hardware.AnalogInput _Vertical;
        ...
        public sbyte HorizontalValue
        {
            get
            {
                ...
                {
                    return (sbyte)this._Horizontal.Read();
                }
                else
                {
                    return (sbyte)(0 - this._Horizontal.Read());
                }
            }
        }
        ...
        public sbyte VerticalValue
        {
            get
            {
                ...
                {
                    return (sbyte)this._Vertical.Read();
                }
                else
                {
                    return (sbyte)(0 - this._Vertical.Read());
                }
            }
        }
        ...
        public ThumbJoystick(Cpu.Pin HorizontalPin, Cpu.Pin VerticalPin, Cpu.Pin PushPin = Cpu.Pin.GPIO_NONE, bool InvertHorizontal = false, bool InvertVertical = false)
        {
            // Configures the analog inputs
            this._Horizontal = new SecretLabs.NETMF.Hardware.AnalogInput(HorizontalPin);
            this._Vertical = new SecretLabs.NETMF.Hardware.AnalogInput(VerticalPin);
            this._Horizontal.SetRange(-50, 50);
            this._Vertical.SetRange(-50, 50);
