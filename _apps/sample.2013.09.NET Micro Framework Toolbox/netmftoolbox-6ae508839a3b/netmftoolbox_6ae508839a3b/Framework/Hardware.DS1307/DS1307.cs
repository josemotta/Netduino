...
namespace Toolbox.NETMF.Hardware
{
    ...
    public class DS1307
    {
        ...
        public DateTime GetTime()
        {
            ...
            return new DateTime(
                second: int.Parse(Tools.Dec2Hex(ReadBuffer[0])),
                minute: int.Parse(Tools.Dec2Hex(ReadBuffer[1])),
                hour:   int.Parse(Tools.Dec2Hex(ReadBuffer[2])),
                day:    int.Parse(Tools.Dec2Hex(ReadBuffer[4])),
                month:  int.Parse(Tools.Dec2Hex(ReadBuffer[5])),
                year:   int.Parse(Tools.Dec2Hex(ReadBuffer[6])) + 2000
            );
        }
